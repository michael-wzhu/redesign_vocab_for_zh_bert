...
from comp_bert.cal_test_metrics import cal_metrics
from comp_bert import data_processors
from comp_bert import modeling
from comp_bert import tokenization
from comp_bert.char_segmented import classifier_utils
...
flags.DEFINE_string("dict_char2comp_dir", None,
                    "The dir to dict_char2comp dict.")
...
def main(_):
    ...
    dict_char2comp = json.load(
        open(FLAGS.dict_char2comp_dir, "r", encoding="utf-8")
    )
