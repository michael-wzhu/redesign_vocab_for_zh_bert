...
python3 comp_bert/run_pretraining.py \
    --input_file=${STORAGE_BUCKET}/experiments/ehr_diagnose/experiments/tf_records/${PREFIX}_${VOCAB_SIZE}/*_train_examples_*_*.tfrecord \
    --output_dir=${STORAGE_BUCKET}/experiments/ehr_diagnose/experiments/pretraining/${PREFIX}_${VOCAB_SIZE}/ \
    --albert_config_file=./comp_bert/albert_configs/config_${VOCAB_SIZE}.json \
    --do_train \
    --do_eval \
    --dev_input_file=${STORAGE_BUCKET}/experiments/ehr_diagnose/experiments/tf_records/${PREFIX}_${VOCAB_SIZE}/*_train_examples_100_*.tfrecord \
    --use_tpu \
    --num_tpu_cores=8 \
    --tpu_name=${TPU_NAME} \
