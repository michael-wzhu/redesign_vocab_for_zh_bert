...
from comp_bert import fine_tuning_utils
from comp_bert import modeling
from comp_bert import optimization

from comp_bert.data_processors import PaddingInputExample
from comp_bert.char_segmented.text_utils import printable_text, char2char_single_sent
...
def convert_single_example(ex_index,
    ...
    tokens_a = char2char_single_sent(
        example.text_a,
    ...
    tokens_b = None
    if example.text_b:
        tokens_b = char2char_single_sent(
            example.text_b,
            dict_char2comp=dict_char2comp,
            sep_token="",
            tokenizer=tokenizer
...
def model_fn_builder(albert_config,
                     num_labels,
                     init_checkpoint,
                     learning_rate,
                     num_train_steps,
