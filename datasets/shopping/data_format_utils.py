...
if __name__ == "__main__":
    ...
    from_dir = "datasets/shopping/train.tsv"
    to_dir = "datasets/shopping/train.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/shopping/train.tsv"
    to_dir = "datasets/shopping/dev.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/shopping/test.tsv"
    to_dir = "datasets/shopping/test.json"
    txt2jsonl(from_dir, to_dir)
