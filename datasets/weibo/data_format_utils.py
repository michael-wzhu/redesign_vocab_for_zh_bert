...
if __name__ == "__main__":
    ...
    from_dir = "datasets/weibo/train.tsv"
    to_dir = "datasets/weibo/train.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/weibo/train.tsv"
    to_dir = "datasets/weibo/dev.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/weibo/test.tsv"
    to_dir = "datasets/weibo/test.json"
    txt2jsonl(from_dir, to_dir)
