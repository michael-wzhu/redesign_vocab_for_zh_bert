...
if __name__ == "__main__":
    ...
    from_dir = "datasets/book_review/train.tsv"
    to_dir = "datasets/book_review/train.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/book_review/train.tsv"
    to_dir = "datasets/book_review/dev.json"
    txt2jsonl(from_dir, to_dir)

    from_dir = "datasets/book_review/test.tsv"
    to_dir = "datasets/book_review/test.json"
    txt2jsonl(from_dir, to_dir)
