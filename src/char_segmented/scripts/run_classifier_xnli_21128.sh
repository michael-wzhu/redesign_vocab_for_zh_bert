...
for run_idx in `seq 1 $((RUN_TIMES))`; do
    ...
    python3 src/char_segmented/run_classifier.py \
      ...
      --output_dir=${STORAGE_BUCKET}/experiments/rethink_vocab/finetune/xnli/${PREFIX}_${VOCAB_SIZE}_length_128_steps_4.5k_time_0625_run_${run_idx}/ \
