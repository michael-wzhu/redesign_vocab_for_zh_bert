...
# python3 src/char_no_space/create_pretraining_data.py --input_file=gs://sbt0/data/corpus/char_no_space_lower/zhwiki-latest-pages-articles_100_char_no_space_lower_simplified.txt --output_file=gs://sbt0/experiments/rethink_vocab/pretrain_tfrecords/char_no_space_21128/zhwiki_train_examples_100_%s.tfrecord --do_lower_case=True --do_whole_word_mask=True --max_seq_length=128 --max_predictions_per_seq=13 --masked_lm_prob=0.1 --dupe_factor=2 --vocab_file data_proc/tokenizers/sentencepiece/char_no_space-21128-clean.vocab --spm_model_file data_proc/tokenizers/sentencepiece/char_no_space-21128-clean.model